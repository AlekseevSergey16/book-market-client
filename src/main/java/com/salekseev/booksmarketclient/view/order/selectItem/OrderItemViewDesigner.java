...
abstract class OrderItemViewDesigner extends StackPane {
    ...
    private void createView() {
        quantityField = new JFXTextField();
        quantityField.setPromptText("Количество экземпляров");
